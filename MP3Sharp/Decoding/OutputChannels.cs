...
public class OutputChannels
{
    ...
    internal static readonly OutputChannels Left = new(LEFT_CHANNEL);
    internal static readonly OutputChannels Right = new(RIGHT_CHANNEL);
    internal static readonly OutputChannels Both = new(BOTH_CHANNELS);
    internal static readonly OutputChannels DownMix = new(DOWNMIX_CHANNELS);
