...
public class RiffFile
{
    ...
    internal static int FourCC(string chunkName)
    {
        ...
        SupportClass.GetSBytesFromString(chunkName, 0, 4, p, 0);
        var ret = ((p[0] << 24) & (int)SupportClass.Identity(0xFF000000)) | ((p[1] << 16) & 0x00FF0000) |
    ...
    public class RiffChunkHeader
    {
        ...
        internal RiffFile EnclosingInstance { get; private set; }

        private void InitBlock(RiffFile enclosingInstance) => EnclosingInstance = enclosingInstance;
    }
}